...
class Snake(pygame.sprite.Sprite):
    ...
    def draw(self, screen):
        for segment in self.snake_body:
            pygame.draw.rect(screen, Color.GREEN, pygame.Rect(segment.x * GameSettings.DEFAULT_SQUARE_SIZE, segment.y * GameSettings.DEFAULT_SQUARE_SIZE, GameSettings.DEFAULT_SQUARE_SIZE, GameSettings.DEFAULT_SQUARE_SIZE))
